...
//
	...
	uvc_frame_t *draw_preview_one(JNIEnv *env, uvc_frame_t *frame, ANativeWindow **window, convFunc_t func, int pixelBytes);
//
...
public:
    ...
    // callback
    Image_object_callback imageObjectCallback = {
            false,
            false,
            nullptr,
            nullptr,
    ...
    int setImageObjectCallback(JNIEnv *env, jobject object_callback_obj);
	int startPreview();
	int stopPreview();
